...
class UDPClient1 implements Runnable {
   ...
   public void run(){ 
      ...
      try{
         ...
         System.out.println("UDP Client-Server SPEED = "+ (input.length()/((total1)/100000))*100 +" KB/s");
         ...
         System.out.println("UDP Server-Client SPEED = "+ (input.length()/((total2)/100)) +" KB/s");
   ...
   public static void main(String args[]) {
      ...
      new Thread(new UDPClient1()).start();
